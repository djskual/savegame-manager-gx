	...
	if(image && tileHorizontal > 0 && tileVertical > 0)
	{
		for(int n=0; n<tileVertical; n++)
			for(int i=0; i<tileHorizontal; i++)
				Menu_DrawImg(currLeft + width * i, currTop + height * n, zoffset, width, height, image, imageangle, widescreen ? currScale * 0.80 : currScale, currScale, this->GetAlpha(), xx1, yy1, xx2, yy2, xx3, yy3, xx4, yy4);
	}
	else if(image && tileHorizontal > 0)
	{
		for(int i=0; i<tileHorizontal; i++)
			Menu_DrawImg(currLeft + width * i, currTop, zoffset, width, height, image, imageangle, widescreen ? currScale * 0.80 : currScale, currScale, this->GetAlpha(), xx1, yy1, xx2, yy2, xx3, yy3, xx4, yy4);
	}
	else if(image && tileVertical > 0)
	{
		for(int i=0; i<tileVertical; i++)
			Menu_DrawImg(currLeft, currTop + height * i, zoffset, width, height, image, imageangle, widescreen ? currScale * 0.80 : currScale, currScale, this->GetAlpha(), xx1, yy1, xx2, yy2, xx3, yy3, xx4, yy4);
	}
	else if(image)
	{
