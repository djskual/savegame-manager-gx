 ...
 ***************************************************************************/
#ifndef _CCUSTOMLIST_HPP_
#define _CCUSTOMLIST_HPP_
...
typedef struct _FileCustomStruct
{
	std::string filename;
...
{
	public:
		CCustomList() { ResetFull(); };
		~CCustomList() { ResetFull(); ResetFiltered(); };
	...
	protected:
		...
		std::vector<FileCustomStruct *> FilesFull;
		std::vector<FileCustomStruct *> FilesFiltered;
};

extern CCustomList CustomList;
