...
class GuiElement
{
	public:
		...
		//!\param l Number of loop of the WARNING effect
		void SetEffect(int e, int a, int t=0, int l=-1);
...
class GuiText : public GuiElement
{
	public:
		...
		int GetFirstLine();
		int GetLineHeight(int n UNUSED);//! returns the height of the #n of lines  including spacing if wrap mode is on
...
class GuiButton : public GuiElement
{
	public:
		...
		//!Sets the button's icon2
		//!\param i Pointer to GuiImage object
		void SetIcon2(GuiImage* i);
	...
	protected:
		...
		GuiImage * icon2; //!< Button icon2 (drawn after button image)
