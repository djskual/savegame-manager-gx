 ...
 * for WiiXplorer 2010
 ***************************************************************************/
#ifndef __ICONEMUMIIBROWSER_HPP_
#define __ICONEMUMIIBROWSER_HPP_
...
class IconEmuMiiBrowser : public GuiFileBrowser
{
	public:
		IconEmuMiiBrowser(Browser * emumiibrowser, GuiImageData * browserBg, int w, int h);
		~IconEmuMiiBrowser();
		void ResetState();
