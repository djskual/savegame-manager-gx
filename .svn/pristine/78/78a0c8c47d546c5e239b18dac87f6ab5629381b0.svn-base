 ...
 * for WiiXplorer 2010
 ***************************************************************************/
#ifndef __LISTEMUBROWSER_HPP_
#define __LISTEMUBROWSER_HPP_
...
class ListEmuBrowser : public GuiFileBrowser
{
	public:
		ListEmuBrowser(Browser * emubrowser, GuiImageData * browserBg, int w, int h);
		~ListEmuBrowser();
		void ResetState();
