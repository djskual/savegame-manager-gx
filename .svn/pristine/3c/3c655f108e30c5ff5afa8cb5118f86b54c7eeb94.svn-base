 ...
 ***************************************************************************/
#ifndef __ICONEMUBROWSER_HPP_
#define __ICONEMUBROWSER_HPP_
...
class IconEmuBrowser : public GuiFileBrowser
{
	public:
		IconEmuBrowser(Browser * emubrowser, GuiImageData * browserBg, int w, int h);
		~IconEmuBrowser();
		void ResetState();
