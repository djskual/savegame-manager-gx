 ...
 * for WiiXplorer 2010
 ***************************************************************************/
#ifndef __LISTEMUMIIBROWSER_HPP_
#define __LISTEMUMIIBROWSER_HPP_
...
class ListEmuMiiBrowser : public GuiFileBrowser
{
	public:
		ListEmuMiiBrowser(Browser * filebrowser, GuiImageData * browserBg, int w, int h);
		~ListEmuMiiBrowser();
		void ResetState();
