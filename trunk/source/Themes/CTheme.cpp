...
void Theme::Reload(bool defaultTheme, short returnToMenu)
{
	SettingsMenu::Instance()->trash();
	...
	delete Application::Instance()->clock;
	
	delete Application::Instance()->bgImg;
	Resources::Remove(Application::Instance()->background);
	
	for(int i = 0; i < 4; ++i)
		delete Application::Instance()->pointer[i];
	...
	Application::Instance()->pointer[0] = new WiiPointer("player1_point.png");
	Application::Instance()->pointer[1] = new WiiPointer("player2_point.png");
	Application::Instance()->pointer[2] = new WiiPointer("player3_point.png");
	Application::Instance()->pointer[3] = new WiiPointer("player4_point.png");
	
	Application::Instance()->background = Resources::GetImageData(Settings.Widescreen ? "menu_wbackground.png" : "menu_background.png");
	Application::Instance()->bgImg = new GuiImage(Application::Instance()->background);
	
	Application::Instance()->clock = new Clock();
	...
	SettingsMenu::Instance()->show(returnToMenu);
}
