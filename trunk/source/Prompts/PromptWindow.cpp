	...
	: GuiFrame(472, 320)
{
	...
	titleTxt = new GuiText(title, thInt("26 - prompt windows title text size"), thColor("r=0 g=0 b=0 a=255 - prompt windows text color"));
	titleTxt->SetAlignment(ALIGN_CENTER | ALIGN_TOP);
	titleTxt->SetPosition(0,55);
	titleTxt->SetMaxWidth(this->GetWidth()-68, DOTTED);

	msgTxt = new GuiText(msg, thInt("22 - prompt windows message text size"), thColor("r=0 g=0 b=0 a=255 - prompt windows text color"));
	msgTxt->SetAlignment(ALIGN_CENTER | ALIGN_MIDDLE);
	msgTxt->SetPosition(0,-40);
	msgTxt->SetLinesToDraw(2);
	msgTxt->SetMaxWidth(this->GetWidth()-68, WRAP);

	btn1Txt = new GuiText(btn1Label, thInt("20 - prompt windows button text size"), thColor("r=0 g=0 b=0 a=255 - prompt windows text color"));
	...
	if(btn2Label)
	{
		btn2Txt = new GuiText(btn2Label, thInt("20 - prompt windows button text size"), thColor("r=0 g=0 b=0 a=255 - prompt windows text color"));
	...
	if(btn3Label)
	{
		btn3Txt = new GuiText(btn3Label, thInt("20 - prompt windows button text size"), thColor("r=0 g=0 b=0 a=255 - prompt windows text color"));
		...
		btn3->SetSoundClick(btnSoundClick);
		if(!btn4Label)
	...
	if(btn4Label)
	{
		btn4Txt = new GuiText(btn4Label, thInt("20 - prompt windows button text size"), thColor("r=0 g=0 b=0 a=255 - prompt windows text color"));
		...
		btn4->SetSoundClick(btnSoundClick);
		if(btn4Label)
